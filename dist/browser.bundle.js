...
const get1 = async (endpoint, options = {
    ...
    if (options.needsToken && !github_token1) throw new Error(`${endpoint} REQUIRES A TOKEN`);
    if (github_token1) options.extraHeaders ? options.extraHeaders.authorization = `token ${github_token1}` : options.extraHeaders = {
